...
const IndiaCases = () => {
    ...
    return (
        <div className="md:flex flex-row justify-between pb-12 relative w-11/12 mx-auto">
             <CasesComponent type="cases" numbers={IndiaCases.confirmed} />
                    ...
                    <h3 className="font-bold absolute bottom-0 right-0 text-center">Last Updated <span className="block">{previosDate()}</span></h3>
        </div>
    )
}

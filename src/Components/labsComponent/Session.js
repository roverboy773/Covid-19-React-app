    ...
    <div className="m-2">
        ...
        <div className="m-1 md:m-3 rounded-xl w-full md:w-auto p-2 bg-blue-100">
            ...
            }
            {
                ...
                <h3 className="font-bold"><span className="mr-1 font-normal">TotalCapacity</span> {ele.available_capacity}</h3>
            }
            <h3 className="font-bold text-center my-2">{ele.vaccine}</h3>
